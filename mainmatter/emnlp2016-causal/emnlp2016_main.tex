...
%\input{mainmatter/emnlp2016-causal/emnlp2016_introduction}
%\input{mainmatter/emnlp2016-causal/emnlp2016_relatedwork}
\input{mainmatter/emnlp2016-causal/emnlp2016_approach}
\input{mainmatter/emnlp2016-causal/emnlp2016_causalextraction}
\input{mainmatter/emnlp2016-causal/emnlp2016_models}
\input{mainmatter/emnlp2016-causal/emnlp2016_directeval}
\input{mainmatter/emnlp2016-causal/emnlp2016_qamodel}
\input{mainmatter/emnlp2016-causal/emnlp2016_qa}
...
\rev{Question classification is an unsolved problem, however, given a set of information needs deemed relevant to a domain and a way to classify questions according to these needs,  we hypothesize that additional embedding spaces customized to the different information needs of questions would allow for robust performance over a larger variety of questions.   }
