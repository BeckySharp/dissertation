...
\begin{figure*}[th!]
\begin{center}
\includegraphics[width=0.50\textwidth]{direct2.pdf} % {rpcurves_all.png}
\vspace{-3mm}
...
For this evaluation, we follow the protocol of Levy and Goldberg~\shortcite{levy2014dependency}.  
