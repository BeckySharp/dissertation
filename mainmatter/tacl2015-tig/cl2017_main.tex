...
\chapter{Interpretable Question Answering: Building and Ranking Intersentence Answer Justifications \label{chapter:cl2017}}

%\input{mainmatter/tacl2015-tig/cl2017_introduction}
%\input{mainmatter/tacl2015-tig/cl2017_relatedwork}
\input{mainmatter/tacl2015-tig/cl2017_approach}
\todo{remove focus word and TAG generation sections -- replace with summaries}
\input{mainmatter/tacl2015-tig/cl2017_focuswords}
\input{mainmatter/tacl2015-tig/cl2017_tig}
\input{mainmatter/tacl2015-tig/cl2017_perceptron}
\input{mainmatter/tacl2015-tig/cl2017_results}
\input{mainmatter/tacl2015-tig/cl2017_discussion}
\input{mainmatter/tacl2015-tig/cl2017_erroranalysis}
\input{mainmatter/tacl2015-tig/cl2017_conclusion}
